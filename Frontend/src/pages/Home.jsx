...
const Home = () => {
    ...
    userSocket.on('ride-confirmed', ride => {
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            {/* <img className='w-16 absolute left-5 top-5' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBqwoU-7QqOwfYObZd_-EbRJsUFwphbgg&s" alt="" /> */}
