...
const CaptainHome = () => {
    ...
    const { captainSocket, rideSocket } = useContext(SocketContext);
    ...
    return (
        <div className='h-screen'>
            <div className='fixed p-6 top-0 flex items-center justify-between w-screen'>
                <img className='w-16' src="https://png.pngtree.com/png-clipart/20230801/original/pngtree-taxi-checkers-flat-vector-icon-on-white-isolated-picture-image_7807730.png" alt="" />
